...
from .models import Event, Activity, Profession, Invited, Attendee, AttendeeType, AttendeePayment, PaymentMethod, EventBadge, Font, AttendeeReceipt, Content, Field, News, Logo, Organization
...
class AttendeeResource(resources.ModelResource):
    class Meta:
        model = Attendee
        fields = ('id', 'first_name', 'last_name', 'document', 'organization', 'position', 'telephone', 'username', 'email', 'country', 'address', 'sex', 'emergency_name', 'emergency_phone', 'extra', 'translation', 'text')
